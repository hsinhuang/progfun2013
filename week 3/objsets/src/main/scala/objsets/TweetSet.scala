...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  override def mostRetweeted: Tweet = {
    def moreRetweeted(a: Tweet, b: Tweet): Tweet = if (a.retweets > b.retweets) a else b
    if (left isEmpty) if (right isEmpty) elem else moreRetweeted(right mostRetweeted, elem)
    else if (right isEmpty) moreRetweeted(elem, left mostRetweeted)
    else moreRetweeted(elem, moreRetweeted(left mostRetweeted, right mostRetweeted))
  }
