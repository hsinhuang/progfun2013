...
class ListsSuite extends FunSuite {
  ...
  test("sum of positive numbers") {
    ...
    assert(sum(List(1,2,19)) === 22)
  }
  
  test("sum of mixed signed numbers") {
    assert(sum(List(1, -1)) === 0)
    assert(sum(List(1, -1, 9, 1, -3)) === 7)
  }
  ...
  test("max of a few positive numbers") {
    ...
    assert(max(List(3, 7, 2, 9)) === 9)
    assert(max(List(11, 3, 7, 2)) === 11)
  }
  
  test("max of a few negative numbers") {
    assert(max(List(-3, -7, -2)) === -2)
    assert(max(List(-3, -7, -2, -9)) === -2)
    assert(max(List(-1, -3, -7, -2)) === -1)
  }
  
  test("max of mixed signed numbers") {
    assert(max(List(3, -7, -2)) === 3)
    assert(max(List(-3, -7, 2, -9)) === 2)
    assert(max(List(1, -3, -7, 2)) === 2)
  }
}
